...
import { BarChart, Clock, Award, Target, Zap, BookOpen, Star } from 'lucide-react';
    ...
    <div className="min-h-screen bg-black p-8">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="space-y-1">
          <h1 className="text-2xl font-bold tracking-tight text-green-500">Progress Tracking</h1>
          <p className="text-gray-400">Monitor your learning journey and case completion statistics</p>
        </div>

        {/* Stats Overview */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          {[
            { title: "Total Cases", value: "16/24", icon: Target, color: "text-blue-500" },
            { title: "Hours Spent", value: "21.5", icon: Clock, color: "text-purple-500" },
            { title: "Certificates", value: "2", icon: Award, color: "text-yellow-500" },
            { title: "Current Streak", value: "5 days", icon: Zap, color: "text-green-500" }
          ].map((stat, index) => (
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div className="space-y-1">
                        ...
                        <div className="flex items-center gap-2">
                          <Badge variant="outline" className="bg-zinc-800 text-green-500 border-green-500">
                            {module.difficulty}
                          </Badge>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        <span className="text-gray-400">
                          Progress: {module.completedCases}/{module.totalCases} cases
                        </span>
                        <span className="text-green-500">{module.progress}%</span>
                      </div>
