...
function Page() {
    ...
    const [editorContent, setEditorContent] = useState("// Start typing your Solidity code here");
    ...
    return (
        <div className="flex min-h-screen">
            <main
                className={`flex-1 p-6 transition-all duration-300 ease-in-out ${!isSidebarOpen ? "md:mr-0" : "md:mr-[300px]"}`}
            >
            ...
            {isSidebarOpen ? <X className="h-6 w-6" /> : <Menu className="h-6 w-6" />}
                ...
                <section className="mb-8">
                    ...
                    <p className="text-lg mb-4">
                        This platform is designed to provide comprehensive learning resources about cryptocurrency, blockchain technology, and trading strategies.
                    </p>
                </section>
                ...
                <section className="mt-8">
                    ...
                    <div className="editor-container" style={{ height: "400px", border: "1px solid #ccc", borderRadius: "4px" }}>
                        <MonacoEditor
                            height="400px"
                ...
                {response && (
                    <section className="mt-8">
                        ...
                        <div className="p-4 border border-gray-300 rounded">
                            <div dangerouslySetInnerHTML={{ __html: response }} /> {/* Render response as HTML */}
                        </div>
                    </section>
                )}
            </main>
