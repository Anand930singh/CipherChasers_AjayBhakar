...
function Page() {
  ...
  return (
    <div className="flex min-h-screen">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {modules.map((module, index) => (
              <div
                key={index}
                className="p-4 bg-card rounded shadow-lg transition-transform transform hover:scale-105 text-white"
              >
                ...
                <div className="mt-4">
                  {module.sections.map((section, sectionIndex) => (
                    <a
                      key={sectionIndex}
                      href={section.href}
                      className="block text-sm text-primary-text hover:underline"
                    >
                      {section.title}
                    </a>
                  ))}
                  ...
                  <ul className="space-y-2">
                    ...
                    <li>
                      <a href="#" className="text-blue-600 hover:underline">
                        ...
                        Bitcoin and Beyond by Chris Burniske and Jack Tatar
                      </a>
                    </li>
                  </ul>
                </div>
      ...
      {/* Desktop sidebar */}
      <aside
        className={`fixed top-1/2 -translate-y-1/2 rounded-l right-0 h-fit hidden md:block transition-transform duration-300 ease-in-out transform ${
          isSidebarOpen ? "translate-x-0" : "translate-x-full"
        } bg-background border w-[300px]`}
      >
        <SidebarContent
          modules={modules}
