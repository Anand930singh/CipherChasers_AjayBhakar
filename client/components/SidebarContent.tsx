...
const SidebarContent: React.FC<SidebarContentProps> = ({ modules, onClose }) => {
  return (
    <div className="h-screen p-4 bg-card">
          ...
          <AccordionItem key={index} value={`module-${index}`}>
            ...
            <AccordionContent>
              <div className="flex flex-col space-y-2">
                ...
                {module.sections.map((section: Section, sectionIndex: number) => (
                  <a
                    key={sectionIndex}
                    href={section.href}
