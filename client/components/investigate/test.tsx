...
export default function Test({ questions }) {
  ...
  // const percentage = Math.round((score / questions.questions.length) * 100);
          ...
          <div>
            ...
            {submitted && (
              <p className="text-sm mt-1">
                Score: {getScoreCount()} / {questions?.questions.length} (
                {Math.round(
                  (getScoreCount() / questions.questions.length) * 100
                )}
                %)
              </p>
            )}
